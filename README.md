...
The nf-artic workflow implements a slightly modified ARTIC FieldBioinformatics
...
```
nextflow run nf-artic --help
```
To update a workflow to the latest version on the command line use
the following command:
```
nextflow pull nf-artic
```
...
|-------|-----------|-------------|--------------------------|
| Workflow report | nf-artic-report.html | Report for all samples. | aggregated |
...
> This workflow was developed and modernized with the assistance of AI pair-programming agents (Google Antigravity / DeepMind). All pipeline logic, schema definitions, and containerized processes have been validated and tested against Oxford Nanopore Technologies (ONT) EPI2ME standards.
